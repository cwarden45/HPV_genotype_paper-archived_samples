A subset of the content on GitHub is used in Supplemental Tables S3 and S4 (with slightly different formatting).

The extended results (and code, for Table S3) is availble within the following "**Extra_Analysis**" subfolders:
