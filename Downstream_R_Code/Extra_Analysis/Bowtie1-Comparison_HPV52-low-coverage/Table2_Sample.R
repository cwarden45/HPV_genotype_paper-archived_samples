...
#input.file = "../../Selected_Output_Files/combined_genotype_with_year_and_ethnicity_freq20.txt"
#input.file = "Bowtie1-combined_genotype_with_year_and_ethnicity_freq5.txt"
input.file = "Bowtie1-combined_genotype_with_year_and_ethnicity_freq20.txt"
