...
HPVtype = "HPV52"
summaryFile = "HPV52_custom_input.txt"
output_suffix = "_ANY-READS.txt"

minFreq = 15

alignmentFolder = "../../../../../../Code/Round20/PEAR-hg38_plus_35HPV_Alignment-Full_Reads_Combined"#these files are large and not on GitHub (but the output of this script is provided)
...
while line:
	...
	if lineCount > 1:
		...
		if HPVresult:
			...
			tempSam = "HPV52/"+sampleID+".sam"
			
			outFA = "HPV52/"+HPVtype+"_"+sampleID + ".fa"
