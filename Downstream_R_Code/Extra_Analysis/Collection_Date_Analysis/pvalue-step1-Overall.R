...
meta.table = meta.table[!is.na(meta.table$collection.year),]
meta.table$batch = as.character(meta.table$batch)
print(dim(meta.table))
...
bGLM.pvalue = apply(status.mat, 2, calc.bGLM.pvalue, var1=meta.table$collection.year, var2=meta.table$batch)
...
lm.pvalue = apply(ab.mat, 1, calc.lm.pvalue, var1=meta.table$collection.year, var2=percent.human, var3=meta.table$batch)
